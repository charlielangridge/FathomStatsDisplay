...
onMounted(function () {
    Nova.request()
        .get("/nova-vendor/fathom-stats-display/siteId")
        .then((response) => {
            siteId.value = response.data;
        });

    Nova.request()
        .get("/nova-vendor/fathom-stats-display/getStats")
        .then((response) => {
...
function updateStats() {
    Nova.request()
        .get("/nova-vendor/fathom-stats-display/getStats/" + timePeriod.value)
        .then((response) => {
            statBlocks.value = response.data.statBlocks;
            timePeriod.value = response.data.timePeriod;
        });
